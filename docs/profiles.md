...
**MCPs**: e2b, memorygraph, context-mode
...
**MCPs**: Core + claude-context, qdrant, sqlite, mcpdoc, crawl4ai, supabase, postgres, memsearch, skill-seekers
...
**MCPs**: Core + mcpdoc, crawl4ai, omnisearch, context7, notion, puppeteer, memsearch, consensus
...
**MCPs**: Core + mcpdoc, omnisearch, context7, puppeteer, daytona, supabase, postgres, memsearch, crawl4ai
**Skills**: autonomous-agent, superpowers, cloudflare
...
**MCPs**: Core + claude-context, mcpdoc (Solana/Helius/Jupiter), omnisearch, daytona, helius, twitter, memsearch, context7
**Skills**: autonomous-agent, solana-foundation, solana-ecosystem, security
...
- Core MCPs (e2b, memorygraph, context-mode) are always included
